            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              ...
              >
                ...
                <div className="relative flex items-center gap-4">
                  <img src={Task} alt="" className="w-14 drop-shadow" />
                  <div>
                    <div className="text-2xl font-bold ">View Tasks</div>
              ...
              >
                ...
                <div className="relative flex items-center gap-4">
                  <img src={Add} alt="" className="w-14 drop-shadow" />
                  <div>
              ...
              >
                ...
                <div className="relative flex items-center gap-4">
                  <img src={Pdf} alt="" className="w-14 drop-shadow" />
                  <div>
              ...
              {activeTab === "taskManager" && (
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    <div>
                      <h3 className="text-2xl font-extrabold text-blue-400 tracking-tight">
                        View Tasks
                      </h3>
                    </div>

                    <div className="text-xs text-gray-400 bg-white/5 border border-white/10 px-4 py-2 rounded-xl">
                      Total Days:{" "}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Left: Filters */}
                    <div className="md:col-span-1 bg-black/30 border border-white/10 rounded-2xl p-6">
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            type="date"
                            className="bg-black/40 border border-white/10 px-4 py-2 rounded-xl text-white w-full outline-none focus:ring-2 focus:ring-blue-500/50"
                            value={from}
...
>
  ...
  hover:scale-105 hover:shadow-lg hover:shadow-purple-500/30"
                    ...
                    <div className="md:col-span-2">
                      {records.length === 0 ? (
                        <div className="border border-white/10 bg-black/30 p-10 rounded-2xl text-center">
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    ...
                    <div className="w-full md:w-auto">
                      ...
                      <input
                        type="date"
                        className="bg-black/40 border border-white/10 px-4 py-2 rounded-xl text-white w-full md:w-60 outline-none focus:ring-2 focus:ring-cyan-500/50"
                        value={taskDate}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div className="md:col-span-1">
                            ...
                            <input
                              ...
                              className="bg-white/5 border border-white/10 px-4 py-2 rounded-xl text-white w-full outline-none focus:ring-2 focus:ring-blue-500/50"
                              value={task.title}
                              onChange={(e) =>
